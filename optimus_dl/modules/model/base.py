...
class BaseModel(torch.nn.Module):
    ...
    def post_optimizer_step(self):
        ...
        _cached_modules = getattr(self, "_post_optimizer_step_modules", None)
        if _cached_modules is None:
            ...
            self._post_optimizer_step_modules = _cached_modules
    ...
    def pre_optimizer_step(self):
        ...
        _cached_modules = getattr(self, "_pre_optimizer_step_modules", None)
        if _cached_modules is None:
            _cached_modules = [
                module
                for module in self.modules()
            ...
            self._pre_optimizer_step_modules = _cached_modules
        for module in _cached_modules:
