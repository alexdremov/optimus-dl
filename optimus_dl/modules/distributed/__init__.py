...
def build_best_collective(
    ...
    if distr:
        ...
        logger.info(f"Built collective: {_collective}")
        return _collective
    else:
        ...
        _collective = FakeCollective(rank=0, world_size=1, device_type=device_type)
        logger.info(f"Built fake collective: {_collective}")
        return _collective
